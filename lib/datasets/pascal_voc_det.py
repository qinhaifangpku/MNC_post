...
class PascalVOCDet(PascalVOC):
    ...
    def _load_sbd_annotations(self, index):
        ...
        if index % 10 == 0:
            ...
            print '~~~~~~~~~~ memory used : %s' % str(psutil.virtual_memory)
            print '~~~~~~~~~~ memory used  precent : %s' % str(psutil.virtual_memory().percent + '%')
            print '~~~~~~~~~~ cpu used : %s' % str(psutil.cpu_percent(0) + '%')
            print '~~~~~~~~~~ cpu used precent : %s' % str(p1.cpu_percent(None) + '%')
